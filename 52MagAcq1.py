...
handler = logging.FileHandler('magnetometer_2_acquisition.log')
...
logger.info("This log entry should show time with -5:00 offset.")

# Define the specific characteristic UUID for magnetometer data
...
DB_FILE = "dhs52v1.db"  # Path to your SQLite database file
...
TABLE_NAME = "magnetometer_data"  # Change table name to reflect magnetometer data
...
def insert_data(data):
    ...
    values = (
        ...
        data.get('x', {}).get('accel', None),  # Adjust to magnetometer-specific data
